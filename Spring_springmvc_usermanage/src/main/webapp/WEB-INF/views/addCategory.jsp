...
<form:form action="${pageContext.request.contextPath}/updateaddcategory" commandName="categoryDTO">
		<table>
			<c:if test="${!empty category.name}">
				<tr>
					...
					<td><form:input path="id" readonly="true" size="8"
							disabled="true" /> <form:hidden path="category.id" /></td>
				</tr>
			</c:if>
			<tr>
			...
			<tr>
				<td><form:label path="parent_id">
						<spring:message text="PID" />
					</form:label></td>
				<td><form:input path="parent_id" readonly="true" size="8"
							disabled="true" /> <form:hidden path="parent_id" /></td>
			</tr>
			<tr>
